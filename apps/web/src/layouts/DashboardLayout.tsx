...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 text-dark font-sans selection:bg-neon selection:text-dark">
      ...
      <header className="w-full bg-tenant-surface border-b border-tenant-border shadow-[0_10px_30px_rgba(0,0,0,0.03)] px-8 py-7 flex justify-between items-center z-20 shrink-0 rounded-b-[2.5rem] border-x-0 border-t-0">
      ...
      {/* Main Page Layout */}
      <div className="flex-1 flex overflow-hidden px-4 sm:px-6 pb-4 sm:pb-6 pt-5 sm:pt-7 gap-6">
