-- Migration: Limit Student Credit Consumption to scenario_practice feature
...
BEGIN
  ...
  -- 2. Check if student has active credit balance (ONLY for scenario_practice feature)
  IF p_student_id IS NOT NULL AND p_feature_id = 'scenario_practice' THEN
